  ...
  <div class="questionnairePage">
    ...
    <div class="content">
      ...
      <div v-if="ques2_display">
        <label class="title">現在入院中ですか。または、最近3ヵ月以内に医師の診察・検察の結果、入院・手術をすすめられたことはありますか？</label>
      ...
      <div v-if="ques3_display">
        <label class="title">過去5年以内に、病気やけがで、手術をうけたことまたは継続して7日以上の入院をしたことがありますか？</label>
...
export default {
  ...
  methods: {
    ...
    movePage(pageName){
      //ストアに保存
      this.$store.commit('questionnaireSave',{ansInstruction: this.ansInstruction
